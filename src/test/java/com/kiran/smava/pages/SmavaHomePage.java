...
import com.kiran.smava.utils.Utils;
...
public class SmavaHomePage {
	...
	public void netLoanAmount(String loanAmount){	
		try {
			...
			utils.valueSelectionFromDropDown(driver, amount, amountsList, amountSelection);
	...
	public void runningTime(String loanTenure){
		try {
			...
			utils.valueSelectionFromDropDown(driver, time, monthsList, tenureSelection);
	...
	public void usageDropDown(String usageSelection){
		try {
			...
			Thread.sleep(4000);
			utils.valueSelectionFromDropDown(driver, usageSelection, UsageDetailsList, useLive);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
